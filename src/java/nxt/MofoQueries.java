...
public final class MofoQueries {
    ...
    public static DbIterator<? extends Block> getBlocks(long accountId, int timestamp, int limit) {
        Connection con = null;
        try {
            con = Db.db.getConnection();
            PreparedStatement pstmt = con.prepareStatement("SELECT * FROM block "
    ...
    public static DbIterator<Trade> getAccountAssetTradesBefore(long accountId, int timestamp, int limit) {
        Connection con = null;
        try {
            con = Db.db.getConnection();
    ...
    public static DbIterator<? extends Transaction> getTransactions(long accountId, int timestamp, int limit, List<TransactionFilter> filters) {
        Connection con = null;
        try {
            con = Db.db.getConnection();
    ...
    public static List<Transaction> getUnconfirmedTransactions(long accountId, int timestamp, int limit, List<TransactionFilter> filters) {
        try (
    ...
    public static List<Transaction> getUnconfirmedTransactions(int timestamp, int limit, List<TransactionFilter> filters) {
        return getUnconfirmedTransactions(0, timestamp, limit, filters);
    }
