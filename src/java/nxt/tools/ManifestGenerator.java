...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/fimk.manifest.mf", Nxt.class.getCanonicalName(), "./lib");
        ...
        manifestGenerator.generate("./resource/fimkservice.manifest.mf", serviceClassName, "./lib");
    }
