...
@Path("/fimk?requestType=getAccountBlocks")
public final class GetAccountBlocks extends APIServlet.APIRequestHandler {
    ...
    @Override
    @Operation(summary = "Get block generated by account",
            tags = {APITag2.ACCOUNT})
    @Parameter(name = "account", in = ParameterIn.QUERY, required = true)
    @Parameter(name = "timestamp", in = ParameterIn.QUERY, schema = @Schema(type = "integer"), description = "from timestamp")
