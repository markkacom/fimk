...
/bin/rm -f fim.zip
zip -qr -9 fim.zip conf/fimk-default.properties conf/logging-default.properties html/ lib/ logs/ fim.jar LICENSE.txt README.txt run.bat run.sh update_fimk.sh
