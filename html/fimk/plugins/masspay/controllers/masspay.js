...
module.controller('MasspayPluginController', function($scope, $rootScope, $timeout, $interval, plugins, nxt, $http, ngTableParams, $sce, modals, $q, db, $location, requests) {
