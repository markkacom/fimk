...
module.controller('ContactsPluginAddModalController', function (items, $modalInstance, $scope, alerts, db, $timeout) {
  ...
  $scope.name_readonly  = !!($scope.items.id_rs) || $scope.items.update;
