...
module.controller('SettingsPluginDBController', function($scope, db, $compile, ngTableParams, $timeout) {
  ...
  function generateTableHTML(schema) {
    ...
    /* html.push('<td><button class="btn btn-xs btn-danger" ng-click="deleteRow(t)">Del</button></td>'); */
